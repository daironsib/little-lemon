    ...
    <View style={styles.item}>
        <View style={styles.itemSection}>
            ...
            <View style={styles.itemBackImage}>
                {image === 'greekSalad.jpg' && <Image source={require('../assets/greekSalad.png')} style={styles.itemImage} />}
                {image === 'bruschetta.jpg' && <Image source={require('../assets/bruschetta.png')} style={styles.itemImage} />}
                {image === 'grilledFish.jpg' && <Image source={require('../assets/grilledFish.png')} style={styles.itemImage} />}
                {image === 'pasta.jpg' && <Image source={require('../assets/pasta.png')} style={styles.itemImage} />}
                {image === 'lemonDessert.jpg' && <Image source={require('../assets/lemonDessert.png')} style={styles.itemImage} />}
            </View>
        </View>
    </View>
);
